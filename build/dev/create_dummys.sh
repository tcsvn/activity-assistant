...
server_address="http://134.2.56.122:8123"
hass_address="http://134.2.56.122:8000"

curl -X POST --user admin:asdf http://localhost:8000/api/v1/server/ -H "Content-Type: application/json" -d "{ \"server_address\": \"$server_address\", \"hass_address\": \"$hass_address\", \"hass_api_token\": \"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJkN2Q1ODZlODRmZTM0NGUyYTE0ZTc5ZTc2ODExZGE2MiIsImlhdCI6MTU1NDkxMzI3NSwiZXhwIjoxODcwMjczMjc1fQ.9aDP7bdxXqmRpndL4yV5B-65W2C0vgLziLskKEZ7fAA\", \"selected_algorithm\":null, \"realtime_node\":null}"
